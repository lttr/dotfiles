---
name: my-simplify
description: Review changed code for naming, comments, structure, and overfitting, then apply the fixes without changing behavior. Quality only, not bug hunting.
disable-model-invocation: true
---

# My Simplify

Adapted from [Ben Holmes' `simplify` skill](https://github.com/bholmesdev/skills/blob/main/skills/simplify/SKILL.md).
